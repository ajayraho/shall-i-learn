	...
	def getJobs(self):
		...
		try:
			...
			return {
				...
				'flexJobs':''.join(filter(str.isdigit,dom.xpath('//*[@id="content-main"]/div[2]/div/div/div[1]/div[2]/div[1]/h4')[0].text.strip().split()[4]))
			}
		except Exception as e:
			return {'indeedJobs':0,'flexJobs':0,'error': str(e), 'injc':jc, 'jobhtml':html}